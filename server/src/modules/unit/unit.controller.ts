...
export class UnitController {
  ...
  @ApiResponse({ status: 201, description: 'Đơn vị cho thuê đã được tạo thành công' })
  @ApiResponse({ status: 400, description: 'Dữ liệu không hợp lệ' })
  @ApiResponse({ status: 404, description: 'Không tìm thấy bất động sản' })
  @ApiResponse({ status: 403, description: 'Không có quyền tạo đơn vị trong bất động sản này' })
  ...
  @ApiResponse({ status: 200, description: 'Danh sách đơn vị cho thuê được trả về thành công' })
  ...
  @ApiResponse({ status: 200, description: 'Thông tin đơn vị cho thuê được trả về thành công' })
  ...
  @ApiResponse({ status: 200, description: 'Đơn vị cho thuê đã được cập nhật thành công' })
  @ApiResponse({ status: 404, description: 'Không tìm thấy đơn vị cho thuê' })
  @ApiResponse({ status: 403, description: 'Không có quyền cập nhật đơn vị cho thuê này' })
  @ApiResponse({ status: 400, description: 'Dữ liệu không hợp lệ' })
  @ApiParam({ name: 'id', description: 'ID của đơn vị cho thuê' })
  update(
    @Param('id') id: string,
  ...
  @ApiOperation({ 
    ...
    description: 'Xóa một đơn vị cho thuê dựa trên ID'
  })
  @ApiResponse({ status: 200, description: 'Đơn vị cho thuê đã được xóa thành công' })
  @ApiResponse({ status: 404, description: 'Không tìm thấy đơn vị cho thuê' })
  @ApiResponse({ status: 403, description: 'Không có quyền xóa đơn vị cho thuê này' })
  @ApiResponse({ status: 400, description: 'Không thể xóa đơn vị cho thuê đang có người thuê' })
  @ApiParam({ name: 'id', description: 'ID của đơn vị cho thuê' })
  ...
  @ApiResponse({ status: 200, description: 'Danh sách đơn vị cho thuê trống được trả về thành công' })
  @ApiResponse({ status: 404, description: 'Không tìm thấy bất động sản' })
  @ApiResponse({ status: 403, description: 'Không có quyền xem thông tin bất động sản này' })
  ...
  @ApiResponse({ status: 200, description: 'Thông tin tóm tắt được trả về thành công' })
  @ApiResponse({ status: 404, description: 'Không tìm thấy đơn vị cho thuê' })
  @ApiParam({ name: 'id', description: 'ID của đơn vị cho thuê' })
