...
export class TenantService {
    ...
    const tenantUnit = await this.prisma.tenantUnit.create({
      data: {
        ...
        moveOutDate: createTenantUnitDto.moveOutDate
          ...
          : undefined,
        contractStartDate: createTenantUnitDto.contractStartDate
          ? new Date(createTenantUnitDto.contractStartDate)
          : undefined,
        contractEndDate: createTenantUnitDto.contractEndDate
          ? new Date(createTenantUnitDto.contractEndDate)
          : undefined,
      },
      include: {
        tenant: true,
  ...
  async getTenantsByUnit(unitId: string) {
    ...
    return tenantUnits.map((tu) => ({
      ...
      contractEndDate: tu.contractEndDate,
    }));
  }
